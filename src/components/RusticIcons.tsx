...
/**
 * Drake's Field Journal / Manuscript Scroll Icon
 */
export function FieldLogIcon({ size = 20, color = '#652B19', className = '', style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <line x1="8" y1="7" x2="16" y2="7" strokeWidth="1.4" />
      <line x1="8" y1="11" x2="16" y2="11" strokeWidth="1.4" />
      <line x1="8" y1="15" x2="13" y2="15" strokeWidth="1.4" />
      <path d="M16 2v6l-2-1.5L12 8V2" fill={color} fillOpacity="0.4" stroke={color} strokeWidth="1" />
    </svg>
  );
}

/**
 * Ancient Spanish Doubloon / Relic Coin Icon
 */
export function RelicCoinIcon({ size = 20, color = '#997A23', className = '', style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <circle cx="12" cy="12" r="7.2" strokeDasharray="2 1.5" strokeWidth="1" />
      <path d="M12 7v10M8.5 9.5l7 5M15.5 9.5l-7 5" strokeWidth="1.4" />
      <circle cx="12" cy="12" r="2.2" fill={color} fillOpacity="0.3" stroke={color} strokeWidth="1.2" />
    </svg>
  );
}

/**
 * Red Wax Seal / Stamp Seal Icon
 */
export function WaxSealIcon({ size = 20, color = '#8B1A1A', className = '', style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M12 2c2 0 3 1.5 4.5 1.5s3-.5 4 1 1 3 2 4.5-.5 3 0 4.5 1.5 3 1 4-2.5 1-3.5 2.5 0 3-1.5 3.5-3-.5-4.5 0-3 1.5-4 1-1-3-2-4.5.5-3 0-4.5-1.5-3-1-4 2.5-1 3.5-2.5 0-3 1.5-3.5 3 .5 4.5 0z"
        fill={color}
        fillOpacity="0.18"
      />
      <circle cx="12" cy="12" r="5" strokeWidth="1.4" />
      <path d="M10 9.5h2a2.5 2.5 0 0 1 0 5h-2v-5z" fill={color} stroke="none" />
    </svg>
  );
}
